...
{!!Form::hidden('clientes_id',$datos->cliente_id,['class'=>'form-control','required'=>'required'])!!}
{!!Form::hidden('poliza_asegurado_id',$datos->id,['class'=>'form-control','required'=>'required'])!!}
