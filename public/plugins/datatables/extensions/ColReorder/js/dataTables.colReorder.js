...
$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo )
{
	...
	{
		this.oApi._fnLog( oSettings, 1, "ColReorder 'form' index is out of bounds: "+iFrom );
		return;
	}
...
var ColReorder = function( dt, opts )
{
	...
	this.s = {
		...
		/**
		 * Number of columns to fix counting form right (not allow to be reordered)
		 *  @property fixedRight
		 *  @type     int
		 *  @default  0
		 */
...
ColReorder.prototype = {
	 ...
	 *//**
	 * Set the order of the columns, form the positions identified in the
	...
	"_fnConstruct": function ()
	{
		...
		/* Columns discounted form reordering - counting left to right */
		if ( this.s.init.iFixedColumns )
		{
			this.s.fixed = this.s.init.iFixedColumns;
		}

		/* Columns discounted form reordering - counting right to left */
	...
	/**
	 * Set the column order form an array
	...
	"_fnMouseMove": function ( e )
	{
		...
		{
			/* Only create the drag element if the mouse has moved a specific distance form the start
...
ColReorder.defaults = {
	...
	/**
	 * Indicate how many columns should be fixed in position (counting form the
